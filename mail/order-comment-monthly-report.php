...
$this->beginPage() ?>
    ...
    <hr/>
    <div><p class="MsoNormal"><span lang="EN-US">Dear, 程慧,<o:p></o:p></span></p>

        <p class="MsoNormal"><span lang="EN-US">&nbsp;</span></p>

        <p class="MsoNormal">附件为上月 <span lang="EN-US">app </span>订单评价报表，请查阅<span lang="EN-US"><o:p></o:p></span></p>
